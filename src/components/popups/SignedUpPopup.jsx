        ...
        <div className="relative w-840px h-680px bg-white rounded-xl shadow-xl">
            ...
            <div className="w-full h-full flex flex-col items-center px-24 pt-112px">
                ...
                <div className="flex flex-col items-center justify-center">
                    ...
                    <div className="flex text-gray-r393e41 font-spoqaMedium text-30px space-x-2">
                        <label>관리자</label>
                ...
                {/* BREAK */}
                <div className="text-gray-r393e41 text-20px font-spoqaMedium flex flex-col items-center justify-center pt-36px">
