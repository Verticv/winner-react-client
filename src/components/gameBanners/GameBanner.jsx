    ...
    return (
        <>
            {selection === 0 ? (
                ...
                <div className="relative flex w-full h-386px border border-gray-afafaf justify-end rounded-lg shadow-plain1 hover:shadow-md transition bg-gradient-to-br from-white via-white to-gray-300 cursor-pointer border border-gray-afafaf">
