        ...
        <div>
            ...
            <div className="mt-15px">
                ...
                <div className="mt-20px w-full flex items-center justify-center mb-60px">
                    <button className="flex items-center justify-center w-192px h-52px rounded-md bg-red-cb4343">
                        <div className="flex items-center justify-center h-50px w-190px rounded-4px border border-red-f36576 bg-gradient-to-b from-red-f03a50 via-red-f03a50 to-red-cf254d cursor-pointer">
