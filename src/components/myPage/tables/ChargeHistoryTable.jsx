        ...
        <table className="shadow-subNavbar rounded-3xl overflow-hidden">
            ...
            <tbody className="w-full text-585858 text-14px tracking-tight font-spoqaMedium">
                <tr className="bg-gray-fefefe rounded-3xl font-spoqaMedium text-14px tracking-tight text-gray-r585858 h-56px w-full border-b border-gray-dddddd">
                    <td className="w-132px font-roboto h-56px text-center flex-shrink-0"><RadioButton id={0}/></td>
                    <td className="w-181px h-56px text-center font-roboto">2021-06-29 15:45:41</td>
                    <td className="w-188px h-56px text-right pr-34px font-roboto">12,000</td>
                    <td className="w-205px h-56px text-right pr-34px text-red-500 font-roboto">+1,000</td>
                    <td className="w-180px h-56px text-center font-roboto">2021-06-29 15:45:41</td>
                ...
                <tr className="bg-gray-f7f9fc rounded-3xl font-spoqaMedium text-14px tracking-tight text-gray-r585858 h-56px border-b border-gray-dddddd">
                    <td className="w-132px font-roboto h-56px text-center flex-shrink-0"><RadioButton id={1}/></td>
                    <td className="w-181px h-56px text-center font-roboto">2021-06-29 15:45:41</td>
                    <td className="w-188px h-56px text-right pr-34px font-roboto">100,000</td>
                    <td className="w-205px h-56px text-right pr-34px text-red-500 font-roboto">+1,000</td>
                    <td className="w-180px h-56px text-center font-roboto">2021-06-29 15:45:41</td>
                ...
                <tr className="bg-gray-fefefe rounded-3xl font-spoqaMedium text-14px tracking-tight text-gray-r585858 h-56px w-full">
                    <td className="w-132px font-roboto h-56px text-center flex-shrink-0"><RadioButton id={2}/></td>
                    <td className="w-181px h-56px text-center font-roboto">2021-06-29 15:45:41</td>
                    <td className="w-188px h-56px text-right pr-34px font-roboto">50,000</td>
                    <td className="w-205px h-56px text-right pr-34px text-red-500 font-roboto">+1,000</td>
                    <td className="w-180px h-56px text-center font-roboto">2021-06-29 15:45:41</td>
                    <td className="w-157px h-56px text-center text-blue-r0056a6">완료</td>
                </tr>
