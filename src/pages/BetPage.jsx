import BetNavListItem from "components/BetNavListItem";
import React, { useState } from "react";
import ufc from "../images/bet/icon-ufc.png";
import basketball from "../images/bet/icon-ufc.png";
// import football from "../images/bet/icon-ufc.png";
// import favorites from "../images/bet/icon-ufc.png";
// import web from "../images/bet/icon-ufc.png";
// import volleyball from "../images/bet/icon-ufc.png";
// import hockey from "../images/bet/icon-ufc.png";
// import placeholder from "../images/bet/icon-ufc.png";
...
export default function BetPage() {
    ...
    const navListItemsDefinition = [
        ...
        {
            id: 3,
            icon: ufc, text: "UFC", number, active: false, marginLeft: "-226px"
        },
        {
            id: 4,
            icon: basketball,
